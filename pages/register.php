...
<div id="register" class="animate form" >
    <form id="registerForm" action="../database/action_register.php" method="post" enctype="multipart/form-data">
        ...
        <input name="username" required="required" pattern="[a-zA-Z0-1]{4,}" title="Must contain only letters and numbers and must be at least 4 characters long!" placeholder="Username *" type="text"/>
